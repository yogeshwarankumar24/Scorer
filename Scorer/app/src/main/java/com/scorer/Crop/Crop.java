...
public class Crop {
    ...
    public static int Topixels(Activity objActivity, int point) {
        float scale = objActivity.getResources().getDisplayMetrics().density;
        int pixels = (int) (point * scale + 0.5f);
        return pixels;
    }
    ...
    /**
     * Send the crop Intent from a FragmentClass
     *
     * @param context  Context
     * @param fragment FragmentClass to receive result
     */
    ...
    /**
     * Send the crop Intent from a support library FragmentClass
     *
     * @param context  Context
     * @param fragment FragmentClass to receive result
     */
    ...
    /**
     * Pick image from a FragmentClass
     *
     * @param context  Context
     * @param fragment FragmentClass to receive result
     */
    ...
    /**
     * Pick image from a support library FragmentClass
     *
     * @param context  Context
     * @param fragment FragmentClass to receive result
     */
    ...
    /**
     * Pick image from a FragmentClass with a custom request code
     *
     * @param context     Context
     * @param fragment    FragmentClass to receive result
     * @param requestCode requestCode for result
    ...
    /**
     * Pick image from a support library FragmentClass with a custom request code
     *
     * @param context     Context
     * @param fragment    FragmentClass to receive result
     * @param requestCode requestCode for result
