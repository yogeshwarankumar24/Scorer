...
public class Player_Adapter extends BaseAdapter {
    ...
    public Player_Adapter(Context context, List<PlayerModel> objPlayerModel) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        player_position.setText(objPlayerModel.get(position).getGamename()+" - "+objPlayerModel.get(position).getPlayerposition());
        Glide.with(context)
